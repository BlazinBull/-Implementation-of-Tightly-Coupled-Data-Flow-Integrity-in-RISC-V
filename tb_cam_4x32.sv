...
// ============================================================================
// tb_cam_4x32.sv
// Self-checking testbench for cam_4x32.
// Verifies: hit -> correct match_addr, no valid entry -> miss, overwrite
// behavior, and that reset clears all entries.
// ============================================================================
...
module tb_cam_4x32;
    ...
    task automatic do_search(input logic [31:0] data);
        ...
        search_en   = 1'b1;
        search_data = data;
        #1; // allow combinational search logic to settle
    endtask
